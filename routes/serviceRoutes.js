...
const {createService, fetchallServices,updateService,deleteServices,fetchOneservice}=require("../contollers/service.js");
...
router.get("/service/fetchOne/:id",fetchOneservice);
